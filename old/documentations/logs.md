...
[
{
  "externalId": "<uuid>",// UNICITÉ / gérer par le client

// CLIENT QUI APPEL (consommateur ou SYMFONY)
  "domain": "corbisier.fr",
  "uri": "/login",
  "method": "POST",
  "ip": "192.168.234.135",
  ...
  "client": "web",
  "version": "1.0.0",
  "<horodatage client>": dateTimeUtc // gérer par client sinon par shared avant persistance 
  "<horodatage create>": datetimeutc

// CLE SI ERREUR IDENTIQUE
  "fingerprint": "abc123",
  "userId": 42,
  "httpStatus": 401,
